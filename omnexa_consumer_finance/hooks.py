...
before_install = "omnexa_consumer_finance.install.enforce_supported_frappe_version"
before_migrate = "omnexa_consumer_finance.install.enforce_supported_frappe_version"
