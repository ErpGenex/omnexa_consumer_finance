...
from omnexa_consumer_finance.governance import (
...
class TestConsumerFinanceGovernance(FrappeTestCase):
	def test_submit_policy_and_snapshot(self):
		...
		pols = list_policy_versions("omnexa_consumer_finance", policy_name="pricing_policy")
		...
		snaps = list_audit_snapshots("omnexa_consumer_finance", process_name="decision_preview", limit=10)
		self.assertTrue(snaps)

		ov = governance_overview("omnexa_consumer_finance")
