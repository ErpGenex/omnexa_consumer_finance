...
from omnexa_consumer_finance.api import get_regulatory_dashboard


class TestConsumerFinanceRegulatoryDashboard(FrappeTestCase):
	def test_get_regulatory_dashboard(self):
		out = get_regulatory_dashboard()
		self.assertEqual(out["app"], "omnexa_consumer_finance")
