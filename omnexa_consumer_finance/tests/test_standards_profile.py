...
from omnexa_consumer_finance.standards_profile import get_standards_profile


class TestConsumerFinanceStandardsProfile(FrappeTestCase):
	def test_standards_profile_minimum_baseline(self):
		profile = get_standards_profile()
		self.assertEqual(profile["app"], "omnexa_consumer_finance")
